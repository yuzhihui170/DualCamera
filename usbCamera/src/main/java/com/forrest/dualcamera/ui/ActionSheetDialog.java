package com.forrest.dualcamera.ui;
...
public class ActionSheetDialog {
    ...
    private void setSheetItems() {
        ...
        for (int i = 1; i <= size; i++) {
            ...
            if (size == 1) {
                if (showTitle) {
                    textView.setBackgroundResource(R.drawable.common_dialog_selection_selector_bottom);
                } else {
                    textView.setBackgroundResource(R.drawable.common_dialog_selection_selector_singleton);
                }
            } else {
                if (showTitle) {
                    if (i >= 1 && i < size) {
                        textView.setBackgroundResource(R.drawable.common_dialog_selection_selector_center);
                    } else {
                        textView.setBackgroundResource(R.drawable.common_dialog_selection_selector_bottom);
                    }
                } else {
                    if (i == 1) {
                        textView.setBackgroundResource(R.drawable.common_dialog_selection_selector_top);
                    } else if (i < size) {
                        textView.setBackgroundResource(R.drawable.common_dialog_selection_selector_center);
                    } else {
                        textView.setBackgroundResource(R.drawable.common_dialog_selection_selector_bottom);
